...
def main():
    ...
    if len(sys.argv) > 2:
        ...
        print("A* Visited: "+str(res[1]))
        print("A* Popped: "+str(res[2]))
        res = dijk(rr,start,end)
        print("Dijkstra Visited: "+str(res[0]))
        print("Dijkstra Popped: "+str(res[1]))
# cProfile.run('main()')
main()
