...
fname = path.abspath('othello_rand.py')
# fname = path.abspath('othello_test2.py')
# gname = path.abspath('Smarter1.py')
gname = path.abspath('othello_comp.py')
...
for gameNum in range(runCount):      # Play a series of games, alternating who goes first
  ...
  print("Predicted tokens: {}".format(int(aTotal[1] * runCount / (gameNum+1))))
  print (" ")
